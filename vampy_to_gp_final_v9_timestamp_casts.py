...
async def resolve_repository_mappings(
    ...
    # В аналитическую карту не включаем четыре служебных продукта.
    analytics_map = {
        repository_id: [
            product
            for product in products
                ...
                if events:
                    execute_values(
                        ...
                        sql.SQL(
                            ...
                            SELECT
                                v.event_id::TEXT,
                                v.event_ts::TIMESTAMP,
                                v.issue_id::TEXT,
                                v.issue_title::TEXT,
                                v.issue_url::TEXT,
                                v.repository_id::TEXT,
                                v.repository::TEXT,
                                v.repository_slug::TEXT,
                                v.severity::TEXT,
                                v.scanner::TEXT,
                                v.previous_status::TEXT,
                                v.new_status::TEXT,
                                v.created_at::TIMESTAMP,
                                v.completed_at::TIMESTAMP,
                                v.ra_deadline::TIMESTAMP,
                                v.is_baseline::BOOLEAN
                            FROM (VALUES %s) AS v (
                                event_id,
                                event_ts,
                                issue_id,
